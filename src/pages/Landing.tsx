      ...
      <section className="relative overflow-hidden bg-black">
        <div className="container relative pt-16 md:pt-24 pb-0">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-6 items-end">
            ...
            className="relative h-[520px] md:h-[640px] lg:h-[720px] -mb-px">
              ...
              {/* iPhone — maior e menos inclinado (contra-rotação suave) */}
              <img
                src={iphoneVitrapay}
                alt="App VitraPay no iPhone"
                style={{ transform: "translateX(-50%) rotate(-8deg)", transformOrigin: "center top" }}
                className="absolute left-1/2 top-[20%] md:top-[18%] h-[240%] md:h-[260%] lg:h-[275%] w-auto object-contain object-top z-10 drop-shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
                loading="lazy"
                decoding="async" />
