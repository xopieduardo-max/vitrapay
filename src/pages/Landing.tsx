...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      {/* ─── Footer ─── */}
      <footer className="relative bg-[#0a0a0a] border-t border-border/20 overflow-hidden">
        {/* Subtle green glow */}
        ...
        <div className="container relative z-10 py-16">
          <div className="grid gap-12 md:grid-cols-12">
            ...
            <div className="md:col-span-4 space-y-5">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed max-w-xs">
                A plataforma de pagamentos que acelera seus resultados digitais. Escale sem medo do escuro.
              </p>
              <div className="flex items-center gap-3 pt-2">
                <a href="https://instagram.com/vitrapay" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors">
                ...
                <a href="#" className="w-10 h-10 rounded-lg border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors">
            ...
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-sm font-semibold text-white">Navegue</h4>
              <div className="flex flex-col gap-3 text-sm text-zinc-400">
                <a href="#features" className="hover:text-white transition-colors">Recursos</a>
                <a href="#pricing" className="hover:text-white transition-colors">Taxas</a>
                <a href="#smart-payment" className="hover:text-white transition-colors">Benefícios</a>
                <a href="#why-us" className="hover:text-white transition-colors">Por que nos escolher</a>
            ...
            {/* Transparência */}
            <div className="md:col-span-2 space-y-4">
              <h4 className="text-sm font-semibold text-white">Transparência</h4>
              <div className="flex flex-col gap-3 text-sm text-zinc-400">
                ...
                <Link to="/purchase-terms" className="hover:text-white transition-colors">Termos de compra</Link>
              </div>
            </div>

            {/* Gerentes de conta */}
            <div className="md:col-span-4 space-y-4">
              <h4 className="text-sm font-semibold text-white">Gerentes de conta</h4>
              <div className="space-y-3">
                <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 rounded-xl border border-zinc-800 hover:border-zinc-600 transition-colors group">
                ...
                <a href="mailto:suporte@vitrapay.com.br" className="flex items-center gap-3 px-4 py-3 rounded-xl border border-zinc-800 hover:border-zinc-600 transition-colors group">
                  <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                  </div>
                  <span className="text-sm text-zinc-400 group-hover:text-white transition-colors">suporte@vitrapay.com.br</span>
                </a>
              </div>
              <div className="flex gap-3 pt-2">
                <Link to="/auth" className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-sm font-medium text-center hover:from-emerald-400 hover:to-emerald-500 transition-all">
                  Crie sua conta
                </Link>
                <Link to="/auth" className="flex-1 px-4 py-2.5 rounded-xl border border-zinc-700 text-white text-sm font-medium text-center hover:bg-zinc-800 transition-colors">
                  Entrar
                </Link>
              </div>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 text-xs font-medium rounded-full border border-zinc-700 text-zinc-400">CNPJ</span>
              <span className="text-xs text-zinc-500">XX.XXX.XXX/0001-XX</span>
            </div>
            <span className="text-xs text-zinc-500">© 2026 VitraPay Tecnologia Ltda. Todos os direitos reservados.</span>
          </div>
        </div>
      </footer>
