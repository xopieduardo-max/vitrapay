  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <footer className="relative bg-[#080808] overflow-hidden">
        ...
        <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[hsl(48,96%,53%)]/[0.15] rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="grid gap-10 md:grid-cols-12 pb-16 border-b border-white/[0.06]">
            ...
            <div className="md:col-span-3 space-y-5">
              ...
              <div className="space-y-2.5">
                <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 rounded-xl border border-white/[0.08] hover:border-white/15 transition-colors group">
                  ...
                  <span className="text-[13px] text-white/35 group-hover:text-white transition-colors">+55 00 0000-0000</span>
                </a>
