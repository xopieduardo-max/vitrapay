...
export default function Dashboard() {
  ...
  // Health score (10 = perfect, lower if high refunds/chargebacks)
  ...
  // Chart data - generate from real sales or fallback
  ...
  return (
    <div className="space-y-5 pb-20 md:pb-6">
      ...
      {/* Bottom Row: Quick Links + Health Score */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Transform CTA */}
