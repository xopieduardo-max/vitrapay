...
const faqItems = [
  ...
  { q: "Quais as taxas cobradas pela VitraPay?", a: "Para Pix, a taxa é R$ 2,49 fixa por venda com recebimento instantâneo (D+0). Para cartão de crédito, 3,99% + R$ 2,49 com recebimento em D+30, ou 4,99% + R$ 2,49 com antecipação D+2. Parcelamento disponível em até 12x conforme o valor do produto — os juros do parcelamento (1,6% a.m.) são repassados ao comprador." },
